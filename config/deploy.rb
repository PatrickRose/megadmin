...
set :repo_url,                'git@git.shefcompsci.org.uk:com3420-2024-25/team12/project.git'
set :linked_files,
    fetch(:linked_files, fetch(:env_links, [])).push('config/credentials.yml.enc', 'config/database.yml',
                                                     'config/master.key')
